...
const doctorList = async (req, res) => {
  try {
    ...
    console.log("doctor data is correctly fetch from model", doctors);
...
const appointmentComplete = async (req, res) => {
  try {
    ...
    if (appointmentData && appointmentData.docId === docId) {
      ...
      return res.json({ success: true, message: "Appointment Completes" });
    } else {
...
const appointmentCancel = async (req, res) => {
  try {
    ...
    if (appointmentData && appointmentData.docId === docId) {
      ...
      return res.json({ success: false, message: "cancel faild" });
    }
  } catch (error) {
    console.log(error);
    res.json({ success: false, message: error.message });
