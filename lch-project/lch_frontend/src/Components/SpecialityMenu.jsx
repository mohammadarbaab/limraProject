    ...
    >
      ...
      <div className="flex sm:justify-center gap-4 p-6 w-full overflow-scroll">
        {specialityData.map((item, index) => (
          <Link
            className="flex flex-col items-center text-xs cursor-pointer flex-shrink-0 hover:translate-y-[-20px] translate-all duration-500 bg-white p-6 rounded-xl shadow-lg border-[#800080] border gap-2"
            key={index}
